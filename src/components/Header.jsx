      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            className={`active-press flex items-center gap-1.5 px-2.5 py-1.5 rounded-full text-xs font-semibold border transition-all ${
              session
          ...
          <button
            ...
            className="active-press flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-white/15 border border-white/25 text-white text-xs font-semibold hover:bg-white/25 transition-all"
          >
