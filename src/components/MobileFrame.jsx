...
export default function MobileFrame({ children }) {
  return (
    <div className="min-h-screen min-h-dvh bg-forest-teal-950 w-full flex items-center justify-center p-0 sm:p-6 md:p-12 overflow-hidden">
      <div className="relative w-full max-w-md h-dvh sm:h-[840px] bg-[#F4F6F8] sm:rounded-[50px] sm:shadow-[0_0_0_12px_var(--color-forest-teal-800),0_20px_50px_rgba(0,0,0,0.85)] flex flex-col overflow-hidden sm:border-[4px] sm:border-forest-teal-800">
        ...
        <div
          ...
          style={{ height: 'env(safe-area-inset-top, 0px)', background: '#E8534A' }}
        />

        {/* App Content */}
        <div className="flex-1 flex flex-col bg-[#F4F6F8] overflow-hidden relative min-h-0">
          {children}
        </div>
